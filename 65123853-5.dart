...
void main() {
  ...
  addStudent(students, "takuya");
  addStudent(students, "maekawa");
  addStudent(students, "maibok");
  addStudent(students, "naja");

  displayStudents(students);

  removeStudent(students, "TK");
  removeStudent(students, "maekawa");
